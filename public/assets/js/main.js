...
function copas(el, link) {
    navigator.clipboard.writeText(link);
    $(".svg-clipboard").attr('fill', "currentColor"); //mengubah semua warna svg menjadi default
    $(".copied").remove(); //menghapus el yang memiliki class copied

    $(el).attr('fill', "red"); //mengubah value dari parameter el menjadi red
